...
const {Config, BaseError, Digest} = require("uu_appg01_core-utils");
...
const {Identity, ClientIdentity, ApplicationIdentity, UuAppKey} = require("uu_appg01_core-authentication");
...
class Session extends CoreSession {
  ...
  constructor(serviceName, oauthClient, supportedAcrValues, claims = null, idToken = null, accessToken = null) {
    ...
    if (attributes) {
      ...
      if (uuIdentity) {
        ...
        let identityData = {name, levelOfAssurance, type, authenticationLevelOfAssurance: identityAcr, uuAppKey};
  ...
  async getCallTokenScope(uri, opts = {}) {
    ...
    } else if (scopeMode === "baseUri" && opts.baseUri) {
