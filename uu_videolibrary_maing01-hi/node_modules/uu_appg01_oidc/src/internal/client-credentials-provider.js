...
class ClientCredentialsProvider {
  ...
  static async getClientCredentials(serviceName) {
    ...
    if (!credentials) {
      ...
      credentials = Config.get(`${CONFIG_PREFIX}${serviceName}${CREDENTIALS_SUFFIX}`);
    }
    ...
    if (!credentials) {
      ...
      let clientSecret = Config.get(`${CONFIG_PREFIX}${serviceName}_unregistered_client_secret`) || "unregistered";
