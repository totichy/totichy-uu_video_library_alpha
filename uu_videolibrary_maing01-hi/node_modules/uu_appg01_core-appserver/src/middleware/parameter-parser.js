...
class ParameterParser {
  ...
  get pre() {
    return [
      ...
      multipartParser,
      ExpressBodyParser.urlencoded({ extended: false, limit: DEFAULT_SIZE_LIMIT }),
      this._parseDotNotation.bind(this),
      ExpressBodyParser.raw({ limit: DEFAULT_SIZE_LIMIT }),
      ExpressBodyParser.text({ limit: DEFAULT_SIZE_LIMIT, type: TEXT_TYPES }),
      jsonParser,
