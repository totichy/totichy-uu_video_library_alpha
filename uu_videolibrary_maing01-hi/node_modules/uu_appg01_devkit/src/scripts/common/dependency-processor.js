...
module.exports = class DependencyProcessor {
  static getCdnName(libName, isUuAppLib) {
    ...
    if (libName === "uu_plus4u5g01-console") {
      ...
      cdnLibName = (libNameBase.indexOf("_") === -1 && libNameBase.match(/^uu/) ? "uu-" + libNameBase : libNameBase).replace(/_/g, "-");
    } else {
  ...
  _computeExternals(packageJsonFile, externalsType, meta = undefined, parentMeta = null, cumulativeResult = {}) {
    ...
    Object.keys(explicitExternals).forEach(externalName => {
      ...
      let { value, cdnVersion, cdnVersionExact } = parentMeta || typeof externalValue !== "object"
