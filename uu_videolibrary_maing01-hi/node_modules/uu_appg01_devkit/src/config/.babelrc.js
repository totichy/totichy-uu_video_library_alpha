...
module.exports = function (mode = process.env.NODE_ENV || "development", processEnvToReplace = null, dynamicImportToRequire = false) {
    ...
    presets = [
      [
        require.resolve("@babel/preset-env"),
        {
          ...
          targets: {
            browsers: fs.readFileSync(__dirname + "/.browserslistrc", "utf-8")
          },
          bugfixes: true,
  ...
  if (!plugins) {
    ...
    if (mode === "test" || dynamicImportToRequire) {
