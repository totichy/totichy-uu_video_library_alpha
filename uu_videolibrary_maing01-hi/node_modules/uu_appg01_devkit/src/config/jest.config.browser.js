...
module.exports = function(pkg, buildDir, useTranspilation = true) {
  let useUu5g05 =
    pkg.name === "uu5g05-test" ||
    (("uu5g05" in (pkg.dependencies || {}) || "uu5g05" in (pkg.devDependencies || {}) || pkg.name === "uu5g05") &&
  ...
  return {
    ...
    reporters: [
      ...
      path.join(__dirname, "jest-console-reporter.js"),
    ],
    ...
    coverageReporters: [],
    verbose: false, // don't report individual tests in a test file; disabling this also makes console output accessible in test report
    ...pkg["jest"]
  };
};
