...
function getUu5g04Dir() {
  if (uu5g04Dir === undefined) {
    let uu5g04Pkg = jestResolve.findNodeModule("uu5g04/package.json", { basedir: path.resolve(".") });
...
module.exports = function (name, options) {
  ...
  if (aliases[name] && !options.basedir.match(/node_modules/)) {
      ...
      if (!result) {
        ...
        if (!options || options.basedir !== curDir) {
          ...
          if (
            ...
            result = jestResolve.findNodeModule(name, Object.assign({}, options, { basedir: getUu5g04Dir() }));
          }
        }
      }
    }
