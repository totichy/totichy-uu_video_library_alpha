...
"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}var i=("0000"+Math.floor(65535*Math.random()).toString(16)).slice(-4),a=function(){function e(t,n){
var o=arguments.length>2&&void 0!==arguments[2]?arguments[2]:null,a=arguments.length>3&&void 0!==arguments[3]?arguments[3]:null;r(this,e),"number"==typeof o&&(a=o,o=null),
this._traceId=t||i+("0000"+Math.floor(65535*Math.random()).toString(16)).slice(-4),this._parentId=n||this._traceId,this._id=o||("00000000"+Math.floor(4294967295*Math.random()).toString(16)).slice(-8),
this._level="number"==typeof a?o?a:a+1:0,this._qualifiedId="".concat(this._traceId,"-").concat(this._parentId,"-").concat(this._id,"-").concat(("0000"+this._level.toString()).slice(-4))}var t,n,a
;return t=e,a=[{key:"create",value:function(t){var n;if(t){if(n=/^([^-]+)-([^-]+)-([^-]+)-([^-]+)$/.exec(t.toString()))return new e(n[1],n[2],n[3],Number(n[4]||0));var r=t.toString().replace(/-/g,"")
;return new e(r,r)}return new e(null,null)}}],(n=[{key:"getTraceId",value:function(){return this._traceId}},{key:"getParentId",value:function(){return this._parentId}},{key:"getId",value:function(){
return this._id}},{key:"getLevel",value:function(){return this._level}},{key:"toString",value:function(){return this._qualifiedId}}])&&o(t.prototype,n),a&&o(t,a),e}();e.exports=a},function(e,t,n){
...
;"/4.0.0/"===(i=i.split(/\//).slice(0,-1).join("/")+"/").substr(-"/4.0.0/".length)&&(i=i.substr(0,i.length-"/4.0.0/".length)+"/4.8.2/"),n.p=i,e.exports=n(9)},function(e,t){e.exports=n
