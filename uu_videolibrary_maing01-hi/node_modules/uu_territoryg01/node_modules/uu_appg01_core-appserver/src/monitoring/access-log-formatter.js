  ...
  _processMessageFormatTag(tag, opts) {
    ...
    switch (tag) {
      ...
      case "p":
        ...
        break;
      case "q":
        result = "(message.req._parsedUrl.query || \"\").replace(/access_token=[^&]+/, 'access_token=hidden')";
        break;
      case "r":
        result =
          'message.tokens["method"](message.req, message.res) + " " + message.tokens["url"](message.req, message.res).replace(/access_token=[^&]+/, \'access_token=hidden\') + " HTTP/" + message.tokens["http-version"](message.req, message.res)';
        break;
      case "s":
