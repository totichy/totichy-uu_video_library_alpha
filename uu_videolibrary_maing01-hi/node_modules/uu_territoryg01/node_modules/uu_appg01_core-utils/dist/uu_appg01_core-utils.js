...
var ConfigChain = __webpack_require__(11);

var Json = __webpack_require__(9);

if (typeof window == "undefined") {
  var DupValidator = __webpack_require__(14);
  ...
  _createClass(Config, null, [{
    ...
    value: function activateProfiles() {
      ...
      if (typeof window == "undefined") {
        ...
        var cfgDir = Object({"NAME":"uu_appg01_core-utils","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core-utils","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})["CONFIG_DIR"] || Config._getDefaultConfigDir();

        var sysCfgDir = Object({"NAME":"uu_appg01_core-utils","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core-utils","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})["SYS_CONFIG_DIR"] || Config._getDefaultSysConfigDir();
    ...
    value: function _getChain() {
      ...
      if (!chain) {
        ...
        if (actProf.length === 0) {
          var envProfiles = Object({"NAME":"uu_appg01_core-utils","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core-utils","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})["CONFIG_PROFILE"] || "development";
    ...
    value: function load() {
      ...
      try {
        if (this._fileSrc !== undefined && this._fileSrc) {
          ...
          var _data = Object({"NAME":"uu_appg01_core-utils","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core-utils","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})[this._senvSrc] || "";

          this._data = this._parse(_data);
        } else if (this._menvSrc !== undefined && this._menvSrc) {
          loadedSrc = this._menvSrc;
          var regex = this._menvSrc;
          var envKeys = Object.keys(Object({"NAME":"uu_appg01_core-utils","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core-utils","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"}));
          var result = {};
          envKeys.forEach(function (key) {
            if (regex.test(key)) {
              result[key.toLowerCase()] = Object({"NAME":"uu_appg01_core-utils","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core-utils","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})[key];
            }
          });
          this._data = result;
        }
...
var ValueConverter = __webpack_require__(12);
...
var _sha = __webpack_require__(27);
...
(function() {
  ...
  var AMD =  true && __webpack_require__(28);
...
var Digest = __webpack_require__(26);

var toPrunedJson = __webpack_require__(30);
/**
