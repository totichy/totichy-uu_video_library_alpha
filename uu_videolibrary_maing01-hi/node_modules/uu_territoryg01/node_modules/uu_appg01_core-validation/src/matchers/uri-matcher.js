...
class _Uri extends Matcher {
  ...
  match(value, ctx, ...args) {
    ...
    let absoluteUri = false;
    if (typeof this.params[0] === "boolean") {
      absoluteUri = this.params[0];
    }
    ...
    if ((typeof value === "string") || (value instanceof String)) {
      ...
      if (!isUri) {
        this.result.addInvalidValueError("uri.e001", "The value must be uri.");
      }
      if (value.length > 1000) {
        this.result.addInvalidValueError("uri.e002", "The value must not exceed 1000 characters.");
      }
    } else {
      this.result.addInvalidTypeError("uri.e001", "The value must be uri.");
    }
