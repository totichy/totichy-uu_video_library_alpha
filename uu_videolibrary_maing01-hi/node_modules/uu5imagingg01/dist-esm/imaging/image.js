...
export const Image = UU5.Common.VisualComponent.create({
  ...
  statics: {
    ...
    classNames: {
      ...
      originalDimensionsWidth: Cfg.CSS + "image-original-dimensions-width",
  ...
  propTypes: {
    ...
    originalDimensions: UU5.PropTypes.bool,
    aspectRatio: UU5.PropTypes.string
  },
  //@@viewOff:propTypes
  ...
  componentDidUpdate(prevProps, prevState) {
    if (
      ((this.props.width !== prevProps.width ||
        ...
        this.props.aspectRatio !== prevProps.aspectRatio) &&
  ...
  _getAspectRatioDimension() {
    let aspectRatioValuesString = this.props.aspectRatio.split(/:|x|\//);
    let aspectRatioWidth = aspectRatioValuesString[0];
    let aspectRatioHeight = aspectRatioValuesString[1];
    let imageWidth = null;
    ...
    this.setState({ aspectRatioWidth: imageWidth, aspectRatioHeight: imageHeight });
  },
  ...
  _onLoad(e) {
    ...
    if (e) {
      ...
      this.setState({ originalWidth: e.target.naturalWidth });
      this.setState({ originalHeight: e.target.naturalHeight });
    }
    ...
    if (this.props.fit === "coverNoScaleUp") {
      let compEl = UU5.Common.DOM.findNode();
