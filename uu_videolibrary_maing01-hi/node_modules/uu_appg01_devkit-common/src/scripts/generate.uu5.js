...
module.exports = class Generate {
  ...
  static async generateComponent(name, packageName, config, isVisual, pack = Package.getSingletonSync("package.json")) {
    ...
    if (!specificConfig.componentList.some(it => it.code === context.tagName)) {
      console.log(`  ../uuapp.json... updating`);
      specificConfig.componentList.push({
        code: context.tagName,
        name: componentNameCamelCase,
        tagList: context.tagName.split("."),
        docCode: context.tagName.replace(/\./g, ""),
        desc: "",
        icon: "",
        imageUri: "",
        uuEccReady: false,
