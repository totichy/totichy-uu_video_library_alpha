...
<html>
  <head>
    ...
    <title><%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %></title>
    ...
    <meta name="apple-mobile-web-app-title" content="<%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>">
    <meta name="application-name" content="<%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>">
  ...
  <body class="clear-sans">
    <div id="uuApp">
      <div class="uu-app-loading">
        ...
        <div class="uu-app-loading-content"><%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %></div>
      </div>
    </div>
