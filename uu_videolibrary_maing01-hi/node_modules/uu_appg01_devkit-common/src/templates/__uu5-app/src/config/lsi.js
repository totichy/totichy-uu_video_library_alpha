const Lsi = {
  appName: {
    cs: "Aplikace <%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>",
    en: "Application <%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>",
  },
  ...
  about: {
    header: {
      cs: "O aplikaci <%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>",
      en: "About application <%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>",
    },
    creatorsHeader: {
      cs: "Tvůrci aplikace",
  ...
  unauthInit: {
    buyYourOwn: {
      cs: "Můžete si koupit vlastní <%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>.",
      en: "You can buy your own <%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>.",
    },
    notAuthorized: {
      cs: "Nemáte právo inicializovat tuto aplikaci <%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>.",
      en: "You don't have rights to initialize this <%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>.",
    },
  },
