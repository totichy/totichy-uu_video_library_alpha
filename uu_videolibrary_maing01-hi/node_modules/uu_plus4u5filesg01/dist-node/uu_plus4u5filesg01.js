...
/* harmony import */ var _core_file_manager_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
...
if (process.env.NODE_ENV !== "test") {
  console.log("".concat("uu_plus4u5filesg01", "-").concat("4.5.1", " \xA9 Unicorn\nTerms of Use: https://unicorn.com/tou/").concat("uu_plus4u5filesg01"));
}
...
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(uu5g04__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var uu5g04_bricks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
...
/* harmony import */ var uu5tilesg01__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(6);
...
/* harmony import */ var _config_lsi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _bricks_file_manager_tile_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(9);
...
/* harmony import */ var _internal_file_paste_handler_mixin_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(58);
/* harmony import */ var _internal_list_wrapper_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(59);
/* harmony import */ var _internal_tools_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(61);
/* harmony import */ var _helpers_file_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(32);
/* harmony import */ var _config_config_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(10);
/* harmony import */ var _calls__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(12);
/* harmony import */ var _file_manager_less__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(62);
...
var FileManager = uu5g04__WEBPACK_IMPORTED_MODULE_0___default.a.Common.VisualComponent.create({
  ...
  getInitialState: function getInitialState() {
    ...
    this._lsiLabels = {
      ...
      addBinaryFormQuality: _config_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].LSI_LABEL_ADD_BINARY_QUALITY,
      addBinaryFormPreserveDimensions: _config_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].LSI_LABEL_ADD_BINARY_PRESERVE_DIMENSIONS,
  ...
  _buildBinaryJson: function _buildBinaryJson(dtoOut) {
    var type = this.props.onSetFileType ? this.props.onSetFileType(dtoOut) : Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_12__["getBinaryData"])(dtoOut);
    var binaryObj = {};
  ...
  _validateCodeUniqueness: function _validateCodeUniqueness(code) {
    return !this.state.binaries.some(function (binary) {
      return binary.code === code;
    });
  },
  _computeFileButtons: function _computeFileButtons() {
    ...
    if (result.itemList && !this.props.onFileShare) {
      var sharingOpts = this._settings.sharingOptions;
      var hasSharingFunction = _typeof(sharingOpts) === "object" && sharingOpts ? Object.keys(sharingOpts).some(function (key) {
        return sharingOpts[key].some(function (opt) {
          return typeof opt.value === "function";
        });
      }) : false;

      if (typeof this.props.uuCmdGetBinaryData === "function" && !hasSharingFunction) {
  ...
  _onSetFiles: function _onSetFiles(fileList, opt) {
    ...
    return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var customCodesEnabled, customCodesRequired, customSizeEnabled, customQualityEnabled, enableImageAdjustments;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              customCodesEnabled = opt ? opt.customCodesEnabled : _this16._settings.dndFileCodeRule !== "none";
              customCodesRequired = opt ? opt.customCodesRequired : _this16._settings.dndFileCodeRule === "required";
              customSizeEnabled = !_this16.props.outputMaxHeight && !_this16.props.outputMaxWidth;
              customQualityEnabled = _this16.props.outputQuality == null;
              _context2.next = 6;
                  ...
                  return regeneratorRuntime.wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          _context.t1 = customQualityEnabled;
                          ...
                          _context.next = 4;
                          return Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_12__["canAdjustQuality"])(file);
                        ...
                        case 5:
                          ...
                          _context.t0 = customSizeEnabled && Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_12__["canAdjustSize"])(file);
            ...
            case 6:
              enableImageAdjustments = _context2.sent.some(Boolean);

              if (customCodesEnabled || _this16.props.availableTags || _this16.props.allowCustomTags || enableImageAdjustments) {
                _this16._openDnDForm(fileList, function (outputFileList, codeList, tagList) {
                  _this16._uploadFiles(outputFileList, codeList, tagList, false);
                }, {
                  customCodesEnabled: customCodesEnabled,
                  customCodesRequired: customCodesRequired
                });
              } else {
                _this16._uploadFiles(fileList, undefined, undefined, true);
              }
  ...
  _onSelect: function _onSelect(opt) {
    if (typeof this.props.onSelect === "function") {
      this.props.onSelect(_objectSpread(_objectSpread({}, opt), {}, {
        component: this
      }));
    }
  },
  _getChild: function _getChild() {
    ...
    return [uu5g04__WEBPACK_IMPORTED_MODULE_0___default.a.Common.Element.create(_forms_form_controller_js__WEBPACK_IMPORTED_MODULE_8__["default"], {
      ...
      validateCodeUniqueness: this._validateCodeUniqueness
...
var Lsi = {
  ...
  LSI_IMAGE_QUALITY_LOW: {
    en: "Low Quality",
    cs: "Nízká kvalita"
  },
  LSI_IMAGE_QUALITY_OPTIMAL: {
    en: "Optimal Quality",
    cs: "Optimální kvalita"
  },
  LSI_IMAGE_QUALITY_MEDIUM: {
    en: "Medium Quality",
    cs: "Střední kvalita"
  },
  LSI_IMAGE_QUALITY_ORIGINAL: {
    en: "Original Quality",
    cs: "Orignální kvalita"
  },
  LSI_IMAGE_QUALITY_TO_JPG_OPTIMAL: {
    en: "Convert to JPG (optimal quality)",
    cs: "Převést na JPG (optimální kvalita)"
  },
  LSI_IMAGE_QUALITY_TO_JPG_MEDIUM: {
    en: "Convert to JPG (medium quality)",
    cs: "Převést na JPG (střední kvalita)"
  },
  LSI_IMAGE_QUALITY_ORIGINAL_PNG: {
    en: "Original PNG",
    cs: "Původní PNG"
  },
  LSI_IMAGE_SIZE_OPTIMAL: {
    en: "Optimal Size",
    cs: "Optimální velikost"
  },
  LSI_IMAGE_SIZE_ORIGINAL: {
    en: "Original Size",
    cs: "Originální velikost"
  },
  LSI_NOT_REQUIRED_CODE_PLACEHOLDER: {
    en: "Code will be generated",
    cs: "Kód bude vygenerován"
  },
  ...
  LSI_LABEL_ADD_BINARY_QUALITY: {
    cs: "Kvalita",
    en: "Quality"
  },
  LSI_LABEL_ADD_BINARY_PRESERVE_DIMENSIONS: {
    cs: "Zachovat rozměry",
    en: "Preserve dimensions"
  },
  LSI_IMAGE_SIZE_WARNING: {
    cs: "Velké obrázky zaplní úložiště rychleji.",
    en: "Large images fill the storage faster."
  },
  LSI_IMAGE_QUALITY_WARNING: {
    cs: "Obrázky ve vysoké kvalitě zaplní úložiště rychleji.",
    en: "High quality images fill the storage faster."
  },
...
/* harmony import */ var uu5imagingg01__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11);
...
/* harmony import */ var _calls_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(12);
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _helpers_css_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
/* harmony import */ var _tag_list_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(15);
/* harmony import */ var _image_from_call_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(16);
/* harmony import */ var _file_manager_tile_less__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(17);
...
var UPDATE_DOWNLOAD_URL_INTERVAL = 10 * 60 * 1000;
...
var FileManagerTile = uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].VisualComponent.create({
  ...
  componentWillUnmount: function componentWillUnmount() {
    if (this._updateDownloadUrlInterval) clearInterval(this._updateDownloadUrlInterval);
    this._authenticatedUrls = {};
  },
  ...
  _updateSrc: function _updateSrc(uuCmd, uuCmdUri) {
    var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
        ...
        _ref$reAuthenticate = _ref.reAuthenticate,
        reAuthenticate = _ref$reAuthenticate === void 0 ? false : _ref$reAuthenticate;
    ...
    if (download && stringSrc && uu5g04__WEBPACK_IMPORTED_MODULE_1__["Environment"].isTrustedDomain(stringSrc)) {
      ...
      var authnUrl = this._getAuthenticatedUrl(stringSrc, session, reAuthenticate);

      if (authnUrl) stringSrc = authnUrl;
    }
  ...
  _getAuthenticatedUrl: function _getAuthenticatedUrl(url, session) {
    ...
    var reAuthenticate = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    // NOTE Not using state because:
    // 1. This is called only for download links at the moment of Download click (or when we want to re-compute authn URL).
    // 2. We don't want to re-render tile at other times (especially not on mount) if authn URL is not needed.
    var result = this._authenticatedUrls[url];

    if (!result || reAuthenticate) {
      uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Tools.getAuthenticatedUrl(url, session).then(function (authenticatedUrl) {
        if (!_this2.isRendered()) return;
        _this2._authenticatedUrls[url] = authenticatedUrl;
      });
    }
        ...
        if (this.props.customSelectable !== "none" && this.props.selectableOnly) {
          ...
          preview = uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create(_image_from_call_js__WEBPACK_IMPORTED_MODULE_7__["default"], {
            ...
            onClick: this.props.onFileClick ? function () {
              return _this3.props.onFileClick(_this3.props.data.binary);
            } : undefined
          });
        }
      } else {
  ...
  _getDownloadLinkData: function _getDownloadLinkData(reAuthenticate) {
    return this._updateSrc(this.props.uuCmdGetBinaryData, this.props.uuCmdGetBinaryDataUri, {
      download: true,
      reAuthenticate: reAuthenticate
    });
  },
  _onDownloadLinkClick: function _onDownloadLinkClick() {
    var _this$_getDownloadLin = this._getDownloadLinkData(),
        data = _this$_getDownloadLin.data,
        stringSrc = _this$_getDownloadLin.stringSrc,
        uuCmd = _this$_getDownloadLin.uuCmd;
  ...
  _updateDownloadUrl: function _updateDownloadUrl() {
    var _this4 = this;

    // make sure that call token gets readied (because we need it in synchronous way
    // when user clicks the Download link) and update it in interval so that it doesn't expire
    if (this._updateDownloadUrlInterval) clearInterval(this._updateDownloadUrlInterval);
    this._updateDownloadUrlInterval = setInterval(function () {
      _this4._getDownloadLinkData(true);
    }, UPDATE_DOWNLOAD_URL_INTERVAL);

    this._getDownloadLinkData(true);
  },
  ...
  _renderButtonPanel: function _renderButtonPanel() {
    ...
    if (this.props.customSelectable !== "none" && this.props.selectableOnly && this.props.data.clickable) {
      buttons.push(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Bricks"].Button, {
        ...
        onClick: function onClick(opt, event) {
          ...
          if (_this5.props.onFileClick) {
            _this5.props.onFileClick(_this5.props.data.binary);
          } else if (_this5._lightbox) {
    ...
    var _loop = function _loop(i) {
      ...
      if (item.active && (_this5.props.customSelectable === "none" || !_this5.props.selectableOnly) && !(_this5.props.tileType === "small" && _this5.props.isS)) {
        alsoAsButton = true;
      }
      ...
      if (alsoAsButton) {
        buttons.push(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Bricks"].Button, {
          ...
          onClick: function onClick(opt, event) {
            event.preventDefault();
            event.stopPropagation();
            if (typeof item.onClick === "function") item.onClick(_this5.props.data.binary, _this5.state.binaryType);
          },
          colorSchema: "primary",
          tooltip: item.label ? _this5.getLsiItem(item.label) : undefined
        }, uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Bricks"].Icon, {
          icon: item.icon
        })));
      }

      if ((!hideDropdown || _this5.props.tileType === "small" && _this5.props.isS) && (_this5.props.customSelectable === "none" || !_this5.props.selectableOnly)) {
        if (item.isDownload) {
          if (dropdownItemsAreDuplicitOnly) dropdownItemsAreDuplicitOnly = alsoAsButton;
          dropdownItems.push(_this5._getDownloadLink(item, i));
        } else {
          if (item.icon !== "mdi-magnify-plus" || item.icon === "mdi-magnify-plus" && _this5.props.data.clickable) {
            if (dropdownItemsAreDuplicitOnly) dropdownItemsAreDuplicitOnly = alsoAsButton;
            dropdownItems.push(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Bricks"].Dropdown.Item, {
              ...
              onClick: function onClick() {
                return item.onClick(_this5.props.data.binary, _this5.state.binaryType);
              },
              key: "dropdownItem" + i
            }));
          }
  ...
  _renderSelectButton: function _renderSelectButton() {
    ...
    return this.props.customSelectable !== "none" && uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Bricks"].Button, {
      ...
      onClick: function onClick(opt, event) {
        return _this6._toggleSelected(event);
      },
  ...
  _getFullInfoBox: function _getFullInfoBox() {
    ...
    return uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create("div", {
      ...
      return uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create(_tag_list_js__WEBPACK_IMPORTED_MODULE_6__["default"], {
        key: "tagList",
        items: _this7.props.data.binary.tagList,
        onTagExpand: _this7.props.handleMeasure,
        className: "tag-list",
        width: size.width,
        height: size.height
      });
    ...
    return uu5g04__WEBPACK_IMPORTED_MODULE_1__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_1__["Bricks"].Div, {
      ...
      mainAttrs: {
        ...
        onClick: function onClick(event) {
          event.preventDefault();
          event.stopPropagation();
          _this8.props.customSelectable !== "none" && _this8.props.selectableOnly ? _this8._toggleSelected() : null;
        }
      }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var uu_appg01__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13);
...
var Calls = {
  ...
  customPostMultipartCmd: function customPostMultipartCmd(baseUri, ucName, dtoIn) {
    ...
    var adjustedDtoIn = _objectSpread(_objectSpread({}, dtoIn), {}, {
      data: formData
    });
...
/* harmony import */ var uu5g04_bricks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);
/* harmony import */ var uu5g04_bricks__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(uu5g04_bricks__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _config_config_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _helpers_css_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
...
var ImageFromCall = Object(uu5g04__WEBPACK_IMPORTED_MODULE_0__["createComponent"])(_objectSpread(_objectSpread({}, STATICS), {}, {
  //@@viewOn:mixins
  //@@viewOff:mixins
  //@@viewOn:propTypes
  propTypes: {
...
function insert(styleEl) {
  ...
  styleEl.setAttribute("data-owner", "uu_plus4u5filesg01/uu_plus4u5filesg01@4.5.1");
  styleEl.setAttribute("data-emotion", "plusu-files");
  styleEl.setAttribute("data-tech", "less"); // insert the style element
  // 1. after last matching data-emotion using technology "less"

  var els = insertionEl.querySelectorAll("style[data-emotion=\"plusu-files\"]");
...
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _helpers_css_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
...
/* harmony import */ var _calls__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(12);
/* harmony import */ var _helpers_css_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(14);
/* harmony import */ var _file_uploader_less__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(56);
...
var FileUploader = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].VisualComponent.create({
  ...
  statics: {
    ...
    classNames: {
      ...
      heightMeasurer: _helpers_css_js__WEBPACK_IMPORTED_MODULE_7__["default"].css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        overflow: hidden;\n      "]))),
      wrapper: function wrapper(props, state) {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_7__["default"].css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        overflow: hidden;\n        transition: height 500ms;\n        ", "\n      "])), !props.dndEnabled ? "height: ".concat(state.height, "px;") : "");
      },
      initialContent: _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].CSS + "file-uploader-initial-content",
      hiddenInitialContent: _helpers_css_js__WEBPACK_IMPORTED_MODULE_7__["default"].css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        visibility: hidden;\n      "]))),
  ...
  setFiles: function setFiles(files, opt) {
    ...
    return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
      var outputFiles, customSizeEnabled, customQualityEnabled, enableImageAdjustments;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              _this._files = _this.state.state === "inProgress" ? _this._files : [];
              ...
              if (!(_this.props.onSetFiles && typeof _this.props.onSetFiles === "function")) {
                _context2.next = 11;
                break;
              }

              _context2.next = 6;
              return _this._adjustFiles(files);

            case 6:
              outputFiles = _context2.sent;
              _this._files = outputFiles;

              _this.props.onSetFiles(outputFiles, opt);

              _context2.next = 26;
              break;

            case 11:
              customSizeEnabled = !_this.props.outputMaxHeight && !_this.props.outputMaxWidth;
              customQualityEnabled = _this.props.outputQuality == null;
              _context2.next = 15;
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          _context.next = 4;
                          return Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["canAdjustQuality"])(file);
                        ...
                        case 5:
                          ...
                          _context.t0 = customSizeEnabled && Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["canAdjustSize"])(file);
            ...
            case 15:
              ...
              if (!(_this.props.customCodesEnabled || enableImageAdjustments)) {
                _context2.next = 21;
                break;
              }
              ...
              _this._openDnDForm(outputFiles);
            ...
            case 23:
              ...
              _this._uploadFiles(outputFiles);
  ...
  _adjustFiles: function _adjustFiles(files) {
    var _this2 = this;

    return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
      var adjustedFiles, i, adjustedFile;
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 2:
              ...
              _context3.next = 5;
              return Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["adjustFile"])(files[i], _this2.props);

            case 5:
              adjustedFile = _context3.sent;
            ...
            case 10:
              return _context3.abrupt("return", adjustedFiles);
  ...
  _openDnDForm: function _openDnDForm(fileList) {
    ...
    this._formController.openDnDForm(fileList, function (outputFileList, codeList) {
      _this4._files = outputFileList;
      _this4._codes = codeList;

      _this4._uploadFiles(outputFileList);
    }, {
  ...
  _getChild: function _getChild() {
    ...
    return uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Fragment, null, uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(_forms_form_controller_js__WEBPACK_IMPORTED_MODULE_2__["default"], {
      ...
      key: "formController",
      ref_: function ref_(r) {
        return _this7._formController = r;
      },
      settings: {
        outputQuality: this.props.outputQuality,
        outputMaxWidth: this.props.outputMaxWidth,
...
/* harmony import */ var _update_binary_meta_data_form_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(39);
/* harmony import */ var _delete_file_form_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(42);
/* harmony import */ var _preview_file_form_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(45);
/* harmony import */ var _share_file_form_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(48);
/* harmony import */ var _dnd_form_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(33);
/* harmony import */ var _controls_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(51);
/* harmony import */ var _form_controller_less__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(54);
...
var FormController = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].VisualComponent.create({
  ...
  propTypes: {
    ...
    sizeLimit: uu5g04__WEBPACK_IMPORTED_MODULE_0__["PropTypes"].number,
    validateCodeUniqueness: uu5g04__WEBPACK_IMPORTED_MODULE_0__["PropTypes"].func
  },
  //@@viewOff:propTypes
  //@@viewOn:getDefaultProps
  getDefaultProps: function getDefaultProps() {
    return {
      ...
      availableTags: undefined,
      sizeLimit: undefined,
      validateCodeUniqueness: undefined
    };
  },
  //@@viewOff:getDefaultProps
  //@@viewOn:standardComponentLifeCycle
  ...
  openDnDForm: function openDnDForm(fileList, onSave, formProps) {
    ...
    var modalContent = {
      ...
      content: uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(_dnd_form_js__WEBPACK_IMPORTED_MODULE_10__["default"], _extends({
        ...
        done: function done(filesData) {
          return _this._onSaveDndForm(filesData, onSave);
        },
        fileList: fileList,
  ...
  _onSaveDndForm: function _onSaveDndForm(filesData, onSave) {
    var files = [];
    var codes = [];
    var tags = [];
...
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(uu5g04__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _config_config_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(10);
/* harmony import */ var _calls_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
/* harmony import */ var _config_lsi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _helpers_file_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(32);
/* harmony import */ var _dnd_form__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(33);
/* harmony import */ var _update_file_form_less__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(37);
/* harmony import */ var _update_file_form_less__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_update_file_form_less__WEBPACK_IMPORTED_MODULE_7__);
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
var UpdateFileForm = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].VisualComponent.create({
  ...
  //@@viewOff:overridingMethods
  //@@viewOn:private
  _registerForm: function _registerForm(ref) {
    this._form = ref;
  },
  _onDone: function _onDone(fileData) {
    var _this = this;

    var _fileData$ = fileData[0],
        file = _fileData$.file,
        originalFile = _fileData$.originalFile;
    var usedIsImage = Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["isImage"])(file);
    var done;

    if (!this.props.shouldSaveThumbnail || !usedIsImage && !this.props.thumbnail) {
      done = this._saveDone;
    } else if (!usedIsImage && this.props.thumbnail) {
      done = this._deleteThumbnail;
    } else {
      done = function done(dtoOut) {
        return _this._saveThumbnail(dtoOut, originalFile);
      };
    }
  ...
  _saveThumbnail: function _saveThumbnail(dtoOut, originalFile) {
    var _this2 = this;

    Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["adjustFile"])(originalFile, {
      outputMaxHeight: 512,
      outputMaxWidth: 512,
      outputQuality: 0.85
    }).then(function (file) {
  ...
  //@@viewOn:render
  render: function render() {
    return uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(_dnd_form__WEBPACK_IMPORTED_MODULE_6__["default"], _extends({}, this.getMainPropsToPass(), {
      done: this._onDone,
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getBinaryData", function() { return getBinaryData; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createObjectURL", function() { return createObjectURL; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getImageElement", function() { return getImageElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getImageFormat", function() { return getImageFormat; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ADJUST_QUALITY_TO_JPG", function() { return ADJUST_QUALITY_TO_JPG; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "canAdjustQuality", function() { return canAdjustQuality; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "canAdjustSize", function() { return canAdjustSize; });
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(uu5g04__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var uu5imagingg01__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
var adjustFile = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _ref2 = _args.length > 1 && _args[1] !== undefined ? _args[1] : {}, outputQuality = _ref2.outputQuality, outputMaxWidth = _ref2.outputMaxWidth, outputMaxHeight = _ref2.outputMaxHeight, outputType = _ref2.outputType;
          ...
          case 3:
            ...
            if (!((outputMaxWidth || outputMaxHeight) && canAdjustSize(data))) {
              _context.next = 15;
              break;
            }
            ...
            _context.prev = 5;
            _context.next = 8;
            return uu5g04__WEBPACK_IMPORTED_MODULE_0__["Imaging"].Adjustment.resizeMax(imageFile, outputMaxWidth, outputMaxHeight);
          ...
          case 12:
            ...
            return _context.abrupt("return", Promise.reject({
              error: Object.assign(_context.t0, {
                code: "resizeFailed"
              })
            }));

          case 15:
            if (!(outputQuality && isJpgRelatedFormat((_getImageFormat = getImageFormat(data)) === null || _getImageFormat === void 0 ? void 0 : _getImageFormat.toLowerCase()) || outputType)) {
              _context.next = 20;
              break;
            }

            _context.next = 18;
            return uu5g04__WEBPACK_IMPORTED_MODULE_0__["Imaging"].Adjustment.changeType(imageFile, outputType || "image/jpeg", outputQuality);

          case 18:
            _result = _context.sent;
            imageFile = _result.imageFile;

          case 20:
            return _context.abrupt("return", imageFile);
...
function getBinaryData(binary) {
  var type;
  var icon;
  var thumbnail = "icon";
  var clickable = false;
  var binaryType = binary.contentType;
  var binaryName = binary.filename;
...
function getImageElement(imageFile) {
...
function getImageFormat(imageFile) {
  if (imageFile && isImage(imageFile)) {
    var splits = imageFile.name.split(".");
    var imageFormat = splits[splits.length - 1];
    return imageFormat;
  } else {
    return undefined;
  }
...
function isJpgRelatedFormat(format) {
  return ["jpg", "jpeg", "jpe", "jif", "jfif", "jfi"].indexOf(format) > -1;
}

var ADJUST_QUALITY_TO_JPG = "toJpg";
function canAdjustQuality(_x2) {
  return _canAdjustQuality.apply(this, arguments);
}

function _canAdjustQuality() {
  _canAdjustQuality = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(imageFile) {
    var _getImageFormat3;

    var format, enabled, metadata;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            format = (_getImageFormat3 = getImageFormat(imageFile)) === null || _getImageFormat3 === void 0 ? void 0 : _getImageFormat3.toLowerCase();
            enabled = isJpgRelatedFormat(format);

            if (!(!enabled && format === "png" && uu5g04__WEBPACK_IMPORTED_MODULE_0__["Imaging"].Adjustment.getImageMetadata)) {
              _context2.next = 7;
              break;
            }

            _context2.next = 5;
            return uu5g04__WEBPACK_IMPORTED_MODULE_0__["Imaging"].Adjustment.getImageMetadata(imageFile);

          case 5:
            metadata = _context2.sent;
            enabled = metadata.transparency ? false : ADJUST_QUALITY_TO_JPG;

          case 7:
            return _context2.abrupt("return", enabled);
...
function canAdjustSize(imageFile) {
  var _getImageFormat2;

  var format = (_getImageFormat2 = getImageFormat(imageFile)) === null || _getImageFormat2 === void 0 ? void 0 : _getImageFormat2.toLowerCase();
  return format && format !== "gif"; // TODO Allow for non-animated gif-s.
}
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  canAdjustSize: canAdjustSize,
  canAdjustQuality: canAdjustQuality,
  ADJUST_QUALITY_TO_JPG: ADJUST_QUALITY_TO_JPG
});
...
/* harmony import */ var _dnd_form_row__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(34);
/* harmony import */ var _helpers_css_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(14);
/* harmony import */ var _helpers_file_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(32);
/* harmony import */ var _dnd_form_less__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(35);
/* harmony import */ var _dnd_form_less__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_dnd_form_less__WEBPACK_IMPORTED_MODULE_8__);
...
var DnDBinaryForm = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].VisualComponent.create({
  ...
  statics: {
    ...
    classNames: {
      ...
      row: _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].CSS + "dnd-form-row " + _helpers_css_js__WEBPACK_IMPORTED_MODULE_6__["default"].css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        padding: 24px 0;\n      "]))),
      ...
      formItem: _helpers_css_js__WEBPACK_IMPORTED_MODULE_6__["default"].css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        &&& {\n          margin: 8px 0 0;\n        }\n      "])))
    },
    opt: {
      nestingLevelWrapper: true
    }
  ...
  componentDidMount: function componentDidMount() {
    ...
    setTimeout(function () {
      return _this._rowRefs[0] && _this._rowRefs[0].focusCodeInput();
  ...
  _onSave: function _onSave() {
    ...
    for (var i = 0; i < this._rowRefs.length; i++) {
  ...
  _getRows: function _getRows() {
    ...
    var outputQuality = this.props.outputQuality ? this.props.outputQuality * 100 : undefined;
    var files = !this.props.fileList || Array.isArray(this.props.fileList) ? this.props.fileList : [this.props.fileList];
    var rows = [];

    var _loop = function _loop(i) {
      var file = files[i];
      rows.push(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(_dnd_form_row__WEBPACK_IMPORTED_MODULE_5__["default"], {
        file: file,
        key: i + "-row",
        ref_: function ref_(ref) {
          return _this2._rowRefs[i] = ref;
        },
        lsiLabels: _this2.props.lsiLabels,
        customCodesEnabled: _this2.props.customCodesEnabled,
        customCodesRequired: _this2.props.customCodesRequired,
        outputMaxHeight: _this2.props.outputMaxHeight,
        outputMaxWidth: _this2.props.outputMaxWidth,
        outputQuality: outputQuality,
        ignoreTags: _this2.props.ignoreTags,
        availableTags: _this2.props.availableTags,
        allowCustomTags: _this2.props.allowCustomTags,
        sizeLimit: _this2.props.sizeLimit,
        validateCodeUniqueness: _this2.props.validateCodeUniqueness,
        tagList: file ? file.tagList : undefined
      }));
      if (i < files.length - 1) rows.push(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Bricks"].Line, {
        key: i + "-line"
      }));
    };
...
/* harmony import */ var _helpers_css_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(14);
/* harmony import */ var _helpers_file_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(32);
/* harmony import */ var _dnd_form_less__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(35);
/* harmony import */ var _dnd_form_less__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_dnd_form_less__WEBPACK_IMPORTED_MODULE_6__);
...
function _getInitialState(props) {
  return {
    file: props.file,
    adjustedFile: props.file,
    src: props.file ? Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["createObjectURL"])(props.file) : undefined,
    quality: props.outputQuality == null ? _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].IMAGE_QUALITY : props.outputQuality,
    ...
    allowResize: true,
    canAdjustQuality: undefined
  };
}

var DnDBinaryForm = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].VisualComponent.create({
  //@@viewOn:mixins
  mixins: [uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].BaseMixin, uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].ElementaryMixin, uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].LsiMixin],
  //@@viewOff:mixins
  //@@viewOn:statics
  statics: {
    tagName: _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].TAG + "DnDBinaryFormRow",
    classNames: {
      main: _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].CSS + "dnd-form-row " + _helpers_css_js__WEBPACK_IMPORTED_MODULE_4__["default"].css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        padding: 24px 0;\n      "]))),
      label: _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].CSS + "dnd-form-row-label",
      labelRequired: _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].CSS + "dnd-form-row-label-required",
      fileInput: function fileInput() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_4__["default"].css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        margin: 0;\n      "])));
      },
      flexWrapper: function flexWrapper() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_4__["default"].css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        display: flex;\n        padding-top: 8px;\n      "])));
      },
      inputs: function inputs() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_4__["default"].css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        flex: 1 1 0;\n\n        & > .uu5-forms-input {\n          &:first-child {\n            margin: 0;\n          }\n\n          &:not(:first-child) {\n            margin: 8px 0 0;\n          }\n        }\n      "])));
      },
      imagePreview: function imagePreview() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_4__["default"].css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        position: relative;\n        flex-basis: ", "px;\n        margin-left: 16px;\n        display: flex;\n        justify-content: center;\n      "])), previewSize);
      },
      imagePreviewMagnify: function imagePreviewMagnify() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_4__["default"].css(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n        display: flex;\n        align-items: center;\n        justify-content: center;\n        position: absolute;\n        top: 4px;\n        right: 4px;\n        width: 24px;\n        height: 24px;\n        opacity: 0.8;\n        background: #FFFFFF;\n        box-shadow: 0 2px 4px 0 rgba(0,0,0,0.50);\n        border-radius: 4px;\n        font-size: 18px;\n        pointer-events: none;\n      "])));
      }
    },
    opt: {
      nestingLevelWrapper: true
  ...
  //@@viewOn:reactLifeCycle
  getInitialState: function getInitialState() {
    this._imageMaxWidth = this.props.outputMaxWidth || _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].IMAGE_WIDTH;
    this._imageMaxHeight = this.props.outputMaxHeight || _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].IMAGE_HEIGHT;
    return _getInitialState(this.props);
  },
  componentDidMount: function componentDidMount() {
    this._adjustFile();
    ...
    this._checkCanAdjustQuality();
  },
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    this._imageMaxWidth = nextProps.outputMaxWidth || _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].IMAGE_WIDTH;
    this._imageMaxHeight = nextProps.outputMaxHeight || _config_config_js__WEBPACK_IMPORTED_MODULE_1__["default"].IMAGE_HEIGHT;

    if (this.props.file !== nextProps.file) {
      this.setState(_getInitialState(nextProps), this._adjustFile);

      this._checkImageSize();

      this._checkCanAdjustQuality(nextProps.file);
    }
  },
  //@@viewOff:reactLifeCycle
  //@@viewOn:interface
  focusCodeInput: function focusCodeInput() {
  ...
  //@@viewOff:overridingMethods
  //@@viewOn:private
  _registerCodeInput: function _registerCodeInput(ref) {
    this._codeRef = ref;
  },
  _checkCanAdjustQuality: function _checkCanAdjustQuality() {
    ...
    return _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              file = _arguments.length > 0 && _arguments[0] !== undefined ? _arguments[0] : _this.props.file;
              _context.next = 3;
              return Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["canAdjustQuality"])(file);
            ...
            case 3:
              ...
              _this.setAsyncState({
                canAdjustQuality: result
              }, function () {
                if (_this.state.canAdjustQuality) _this._adjustFile();
              });
  ...
  _onChangeConversionQuality: function _onChangeConversionQuality(_ref) {
    var value = _ref.value;

    var qualityFeedback = _objectSpread({}, initialFeedback);

    if (value === "high" || value === "original") {
      qualityFeedback.feedback = "warning";
      qualityFeedback.message = _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_QUALITY_WARNING);
    }

    this.setState({
      quality: qualityMap[value],
      qualityFeedback: qualityFeedback
    }, this._adjustFile);
  },
  _onChangeQuality: function _onChangeQuality(_ref2) {
  ...
  _onChangePreserveDimensions: function _onChangePreserveDimensions(_ref3) {
    var value = _ref3.value;

    var sizeFeedback = _objectSpread({}, initialFeedback);

    if (value === "original") {
      sizeFeedback.feedback = "warning";
      sizeFeedback.message = _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_SIZE_WARNING);
    }

    this.setState({
      preserveDimensions: sizeMap[value],
      sizeFeedback: sizeFeedback
    }, this._adjustFile);
  },
  _onChangeCode: function _onChangeCode(_ref4) {
    var value = _ref4.value;
    this.setState({
      code: value
    });
  },
  _onBlurCode: function _onBlurCode(_ref5) {
    var value = _ref5.value;
    var correctFormat = !value || !!value.match(/^([a-zA-Z0-9_]){3,64}$/g);
    var uniqueCode = value && typeof this.props.validateCodeUniqueness === "function" ? this.props.validateCodeUniqueness(value) : true;
    var correctValue = !!(!this.props.customCodesRequired || value);

    var codeFeedback = _objectSpread({}, initialFeedback);

    if (!correctFormat || !uniqueCode || !correctValue) {
      var message;

      if (!correctValue) {
        message = _config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_REQUIRED_CODE;
      } else if (!correctFormat) {
        message = _config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_INVALID_CODE;
      } else if (!uniqueCode) {
        message = _config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_DUPLICATE_CODE;
      }

      codeFeedback.feedback = "error";
      codeFeedback.message = _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(message);
    }
  ...
  _onChangeTags: function _onChangeTags(_ref6) {
    var value = _ref6.value;
    this.setState({
      tags: value
    });
  },
  _onChangeFile: function _onChangeFile(_ref7) {
    var _this2 = this;
    ...
    this.setState({
      ...
      _this2._checkImageSize();

      _this2._checkCanAdjustQuality(_this2.state.file);
    });
  },
  _checkImageSize: function _checkImageSize() {
    var _this3 = this;

    if (Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["isImage"])(this.state.file)) {
      Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["getImageElement"])(this.state.file).then(function (imageElement) {
        if (!_this3.isRendered()) return;
        ...
        _this3.setState(function (state) {
          var newAllowResize = imgHeight > _this3._imageMaxHeight || imgWidth > _this3._imageMaxWidth;
          var result = state.allowResize !== newAllowResize ? {
            allowResize: newAllowResize
          } : undefined;
          changed = !!result;
          return result;
        }, function () {
          return changed ? _this3._adjustFile() : undefined;
        });
      });
    }
  },
  _adjustFile: function _adjustFile() {
    var _this4 = this;

    var file = this.state.file;
    var maxWidth = this.state.preserveDimensions ? undefined : this._imageMaxWidth;
    var maxHeight = this.state.preserveDimensions ? undefined : this._imageMaxHeight;

    if (file) {
      var runId = this._runId = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Tools.generateUUID();
      Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["adjustFile"])(file, {
        outputQuality: this.state.quality !== qualityMap.original ? this.state.quality / 100 : undefined,
        outputMaxWidth: maxWidth != null && this.state.allowResize ? maxWidth : undefined,
        outputMaxHeight: maxHeight != null && this.state.allowResize ? maxHeight : undefined,
        outputType: this.state.quality !== qualityMap.original && this.state.canAdjustQuality === _helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["ADJUST_QUALITY_TO_JPG"] ? "image/jpeg" : undefined
      }).then(function (adjustedFile) {
        if (!_this4.isRendered() || runId !== _this4._runId) return;
        var newState = {
          adjustedFile: adjustedFile,
          src: Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["createObjectURL"])(adjustedFile),
          fileFeedback: _objectSpread({}, initialFeedback)
        };

        if (adjustedFile && adjustedFile.size > Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["getMaxFileSize"])(_this4.props.sizeLimit) * 1024) {
          newState.fileFeedback.feedback = "error";
          newState.fileFeedback.message = _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_this4.props.lsiLabels.fileSizeExceededError, {
            maxSize: Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["getMaxFileSize"])(_this4.props.sizeLimit)
          });
        } else {
      ...
      this.setState(_getInitialState(_objectSpread(_objectSpread({}, this.props), {}, {
        file: file
      })));
    }
  },
  ...
  render: function render() {
    var _this$props = this.props,
        availableTags = _this$props.availableTags,
        allowCustomTags = _this$props.allowCustomTags,
        customCodesRequired = _this$props.customCodesRequired,
        ignoreTags = _this$props.ignoreTags,
        outputQuality = _this$props.outputQuality,
        outputMaxHeight = _this$props.outputMaxHeight,
        outputMaxWidth = _this$props.outputMaxWidth;
    var _this$state = this.state,
        file = _this$state.file,
        adjustedFile = _this$state.adjustedFile,
        quality = _this$state.quality,
        preserveDimensions = _this$state.preserveDimensions,
        tags = _this$state.tags,
        code = _this$state.code,
        src = _this$state.src,
        fileFeedback = _this$state.fileFeedback,
        codeFeedback = _this$state.codeFeedback,
        sizeFeedback = _this$state.sizeFeedback,
        qualityFeedback = _this$state.qualityFeedback,
        allowResize = _this$state.allowResize;
    var showTags = availableTags || allowCustomTags;
    var usedIsImage = Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["isImage"])(file);
    var codePlaceholder = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Tools.getLsiValueByLanguage(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"][customCodesRequired ? "LSI_LABEL_ADD_BINARY_CODE_REQUIRED" : "LSI_NOT_REQUIRED_CODE_PLACEHOLDER"], this.getLanguage());
    availableTags = Array.isArray(availableTags) ? availableTags.map(function (tag) {
      return {
        value: tag,
        content: tag
      };
    }) : undefined;
    return uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Bricks"].Row, this.getMainPropsToPass(), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].File, _extends({
      className: this.getClassName("fileInput"),
      value: adjustedFile,
      onChange: this._onChangeFile,
      required: true
    }, fileFeedback)), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create("div", {
      className: this.getClassName("flexWrapper")
    }, uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create("div", {
      className: this.getClassName("inputs")
    }, this.props.customCodesEnabled ? uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Text, _extends({
      ref_: this._registerCodeInput,
      inputAttrs: {
        autoComplete: "off"
      },
      required: customCodesRequired,
      requiredMessage: customCodesRequired && _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_LABEL_ADD_BINARY_CODE_REQUIRED),
      value: code,
      onChange: this._onChangeCode,
      onBlur: this._onBlurCode,
      placeholder: codePlaceholder
    }, codeFeedback)) : null, showTags ? uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].TagSelect, {
      ...
      multiple: true
    }) : null, outputQuality == null && this.state.canAdjustQuality === _helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["ADJUST_QUALITY_TO_JPG"] ? uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select, _extends({
      value: Object.keys(qualityMap).find(function (item) {
        return quality === qualityMap[item];
      }),
      onChange: this._onChangeConversionQuality
    }, qualityFeedback), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select.Option, {
      value: "optimal",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_QUALITY_TO_JPG_OPTIMAL)
    }), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select.Option, {
      value: "medium",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_QUALITY_TO_JPG_MEDIUM)
    }), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select.Option, {
      value: "original",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_QUALITY_ORIGINAL_PNG)
    })) : outputQuality == null && this.state.canAdjustQuality ? uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select, _extends({
      value: Object.keys(qualityMap).find(function (item) {
        return quality === qualityMap[item];
      }),
      ...
      value: "low",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_QUALITY_LOW)
    }), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select.Option, {
      value: "optimal",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_QUALITY_OPTIMAL)
    }), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select.Option, {
      value: "medium",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_QUALITY_MEDIUM)
    }), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select.Option, {
      value: "original",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_QUALITY_ORIGINAL)
    })) : null, !outputMaxHeight && !outputMaxWidth && Object(_helpers_file_js__WEBPACK_IMPORTED_MODULE_5__["canAdjustSize"])(file) ? uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select, _extends({
      value: allowResize ? Object.keys(sizeMap).find(function (item) {
        return preserveDimensions === sizeMap[item];
      }) : "original",
      onChange: this._onChangePreserveDimensions,
      disabled: !allowResize
    }, sizeFeedback), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select.Option, {
      value: "optimal",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_SIZE_OPTIMAL)
    }), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Select.Option, {
      value: "original",
      content: _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__["default"].getLsiComponent(_config_lsi_js__WEBPACK_IMPORTED_MODULE_2__["default"].LSI_IMAGE_SIZE_ORIGINAL)
    })) : null), usedIsImage ? uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create("div", {
      className: this.getClassName("imagePreview")
    }, uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Imaging"].Image, {
      src: src,
      width: previewSize,
      height: previewSize,
      fit: "coverNoScaleUp"
      ...
      className: this.getClassName("imagePreviewMagnify")
    })) : null));
  } //@@viewOff:render
...
/* harmony import */ var _config_lsi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _add_file_form_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(40);
/* harmony import */ var _add_file_form_less__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_add_file_form_less__WEBPACK_IMPORTED_MODULE_5__);
function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }
...
var UpdateBinaryMetaDataForm = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].VisualComponent.create({
  ...
  render: function render() {
    ...
    var availableTags = Array.isArray(this.props.availableTags) ? this.props.availableTags.map(function (tag) {
      return {
        value: tag,
        content: tag
      };
    ...
    return uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].Form, _extends({}, this.getMainPropsToPass(), {
      ...
      spacing: 8
    }), uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].Element.create(uu5g04__WEBPACK_IMPORTED_MODULE_0__["Forms"].TagSelect, {
...
/* harmony import */ var _config_lsi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _delete_file_form_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(43);
...
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(uu5g04__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _calls_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
/* harmony import */ var _config_config_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(10);
/* harmony import */ var _config_lsi_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(7);
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(8);
/* harmony import */ var _preview_file_form_less__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(46);
...
/* harmony import */ var _config_lsi_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _share_file_form_less__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(49);
...
var ShareFileForm = uu5g04__WEBPACK_IMPORTED_MODULE_0__["Common"].VisualComponent.create({
  ...
  _getOutput: function _getOutput() {
    ...
    if (typeof output === "function") {
      output = output(this.props.binary);
    } else {
...
/* harmony import */ var _config_lsi_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(7);
/* harmony import */ var _helpers_lsi_helper_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(8);
/* harmony import */ var _controls_less__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(52);
...
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var uu5g04__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(uu5g04__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var uu5g04_bricks__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
...
/* harmony import */ var uu5tilesg01__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6);
...
/* harmony import */ var _helpers_css_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(14);
/* harmony import */ var _config_lsi_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(7);
var _templateObject, _templateObject2, _templateObject3, _templateObject4, _templateObject5, _templateObject6;
...
var ListWrapperBody = uu5g04__WEBPACK_IMPORTED_MODULE_1___default.a.Common.VisualComponent.create({
  ...
  statics: {
    classNames: {
      main: function main() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_5__["default"].css(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n        position: relative;\n      "])));
      },
      ...
      dndHoverArea: function dndHoverArea() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_5__["default"].css(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n        right: 0;\n        background: rgba(250, 250, 250, 0.95);\n        border: 4px dashed rgba(0, 0, 0, 0.17);\n      "])));
      },
      hintWrapper: function hintWrapper() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_5__["default"].css(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        position: absolute;\n        left: 0;\n        right: 0;\n        top: ", ";\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n      "])), typeof state.positionY === "number" ? state.positionY + "px" : "0");
      },
      hintIcon: function hintIcon() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_5__["default"].css(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        font-size: 80px;\n        color: #616161;\n        width: 80px;\n        height: 80px;\n        display: flex;\n        align-items: center;\n      "])));
      },
      hintText: function hintText() {
        return _helpers_css_js__WEBPACK_IMPORTED_MODULE_5__["default"].css(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        font-size: 24px;\n      "])));
      }
    }
  },
  //@@viewOff:statics
  ...
  _getHintWrapperClassName: function _getHintWrapperClassName() {
    if (this._hasRendered) {
      ...
      return _helpers_css_js__WEBPACK_IMPORTED_MODULE_5__["default"].css(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n        position: absolute;\n        left: 0;\n        right: 0;\n        top: ", ";\n        display: flex;\n        flex-direction: column;\n        align-items: center;\n      "])), typeof positionY === "number" ? positionY + "px" : "0");
    }
  },
  //@@viewOff:private
  //@@viewOn:render
