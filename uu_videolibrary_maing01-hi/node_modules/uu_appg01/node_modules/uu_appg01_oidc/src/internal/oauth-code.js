...
class OAuthCode {
  ...
  async get(clientId, scope = null) {
    ...
    return await new Promise(async (resolve, reject) => {
      ...
      let authzUri = await this.getAuthorizationUri(redirectUri, clientId, null, scope);
      opn(authzUri);
    });
  }
  ...
  async getAuthorizationUri(redirectUri, clientId, acrValues, scope = null) {
    ...
    } else if (Config.isProfileActive("development", "test")) {
      scope = `${OAUTH_SCOPE_OPENID} ${LocalDomainHandler.getLocalDomainScope()}`;
    } else {
