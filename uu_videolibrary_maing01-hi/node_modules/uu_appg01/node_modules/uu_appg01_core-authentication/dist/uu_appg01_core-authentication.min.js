...
;"/4.0.0/"===(o=o.split(/\//).slice(0,-1).join("/")+"/").substr(-"/4.0.0/".length)&&(o=o.substr(0,o.length-"/4.0.0/".length)+"/4.8.2/"),n.p=o,t.exports=n(6)},function(t,n){t.exports=e
...
if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}(this,t)}var e,n,o,a,f;return e=t,n=null,o=[{key:"DEFAULT_PROVIDER_PARAM",get:function(){
return"uu_app_default_authn_provider"}},{key:"authenticate",value:(a=regeneratorRuntime.mark((function e(n){var r,i,o=arguments;return regeneratorRuntime.wrap((function(e){
for(;;)switch(e.prev=e.next){case 0:if(r=o.length>1&&void 0!==o[1]?o[1]:null,i=t.get(),!r){e.next=8;break}return e.next=5,i.authenticate(n,r);case 5:return e.abrupt("return",e.sent);case 8:
return e.next=10,i.authenticate(n);case 10:return e.abrupt("return",e.sent);case 11:case"end":return e.stop()}}),e)})),f=function(){var t=this,e=arguments;return new Promise((function(n,i){
var o=a.apply(t,e);function u(t){r(o,n,i,u,c,"next",t)}function c(t){r(o,n,i,u,c,"throw",t)}u(void 0)}))},function(t){return f.apply(this,arguments)})},{key:"get",value:function(){
var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,n=e||c.get("uu_app_default_authn_provider")
...
;throw new u('There is no authentication provider with name "'.concat(n,'".'))}},{key:"_register",value:function(e,n){t._realizations[e]=n}}],n&&i(e.prototype,n),o&&i(e,o),t}();a._realizations={},
t.exports=a},function(t,e,n){"use strict";function r(t,e,n,r,i,o,u){try{var c=t[o](u),a=c.value}catch(t){return void n(t)}c.done?e(a):Promise.resolve(a).then(r,i)}function i(t){return function(){
var e=this,n=arguments;return new Promise((function(i,o){var u=t.apply(e,n);function c(t){r(u,i,o,c,a,"next",t)}function a(t){r(u,i,o,c,a,"throw",t)}c(void 0)}))}}function o(t,e){
if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function u(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,
"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}var c=n(2),a=function(){function t(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};o(this,t),this._id=e.id||null,
