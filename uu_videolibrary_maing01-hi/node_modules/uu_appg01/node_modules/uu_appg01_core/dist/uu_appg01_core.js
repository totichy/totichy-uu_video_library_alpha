...
if (uri.substr(-floatingVersion.length) === floatingVersion) uri = uri.substr(0, uri.length - floatingVersion.length) + "/4.8.2/";
...
var PerflogHandler = __webpack_require__(141);

var RemoteErrorHandler = __webpack_require__(149);

var TransformParametersHandler = __webpack_require__(153);

var UriHandler = __webpack_require__(157);

var RetryHandler = __webpack_require__(158);

var DEFAULT_INTERCEPTORS = [PerflogHandler, UriHandler, RemoteErrorHandler, RetryHandler, TransformParametersHandler];
/**
  ...
  _createClass(Config, null, [{
    ...
    value: function activateProfiles() {
      ...
      if (typeof window == "undefined") {
        ...
        var cfgDir = Object({"NAME":"uu_appg01_core","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})["CONFIG_DIR"] || Config._getDefaultConfigDir();

        var sysCfgDir = Object({"NAME":"uu_appg01_core","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})["SYS_CONFIG_DIR"] || Config._getDefaultSysConfigDir();
    ...
    value: function _getChain() {
      ...
      if (!chain) {
        ...
        if (actProf.length === 0) {
          var envProfiles = Object({"NAME":"uu_appg01_core","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})["CONFIG_PROFILE"] || "development";
    ...
    value: function load() {
      ...
      try {
        if (this._fileSrc !== undefined && this._fileSrc) {
          ...
          var _data = Object({"NAME":"uu_appg01_core","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})[this._senvSrc] || "";

          this._data = this._parse(_data);
        } else if (this._menvSrc !== undefined && this._menvSrc) {
          loadedSrc = this._menvSrc;
          var regex = this._menvSrc;
          var envKeys = Object.keys(Object({"NAME":"uu_appg01_core","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"}));
          var result = {};
          envKeys.forEach(function (key) {
            if (regex.test(key)) {
              result[key.toLowerCase()] = Object({"NAME":"uu_appg01_core","VERSION":"4.8.2","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser"})[key];
            }
          });
          this._data = result;
        }
...
module.exports = {
  Perflog: __webpack_require__(143),
  Section: __webpack_require__(145),
  SectionId: __webpack_require__(148),
  Logger: __webpack_require__(146),
  MessageFormatter: __webpack_require__(147)
};
...
var Section = __webpack_require__(145);

var SectionId = __webpack_require__(148);
...
var MessageFormatter = __webpack_require__(147);
...
var ApplicationError = __webpack_require__(150);

var SystemError = __webpack_require__(152);
/**
...
var RemoteError = __webpack_require__(151);
...
var ContentTransformers = __webpack_require__(154);
...
var MultiPart = __webpack_require__(155);

var dotNotate = __webpack_require__(156);
...
var RetryHandlerCore = __webpack_require__(159);
/**
...
var InvalidParameters = __webpack_require__(160);
...
var UriBuilder = __webpack_require__(164);

var InvalidUriPartError = __webpack_require__(166);
...
var UriParser = __webpack_require__(165);
/**
...
var UntrustedCredentials = __webpack_require__(170);
/**
...
var AuthenticationError = __webpack_require__(171);
/**
