...
var LogLevel=__webpack_require__(1),_require=__webpack_require__(0),BaseError=_require.BaseError,Json=_require.Json,LoggerMDC=__webpack_require__(4),FORMAT_TAGS=/(%(?:{([^}]*)})?([a-zA-Z%]))/g,DEFAULT_SEVERITY_LABELS="DEBUG INFO WARN ERROR FATAL ANY OFF",DEFAULT_MESSAGE_FORMAT="[%d] %{5}s %n: %m%e",DEFAULT_ERROR_FORMAT="\n  %i [%t] %c: %m\n    %{\n    }b%{\n  Caused by:}C",ENTRY_SEPARATOR="\n",MessageFormatter=function(){
...
;a.enumerable=a.enumerable||!1,a.configurable=!0,"value"in a&&(a.writable=!0),Object.defineProperty(e,a.key,a)}}var n=t(0),o=n.ContextStore,i=n.Json,s=t(9),u=s.getFactory,c=s.setFactory,l=function(){
function e(){!function(e,r){if(!(e instanceof r))throw new TypeError("Cannot call a class as a function")}(this,e)}var r,t,n;return r=e,n=[{key:"create",value:function(){
var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null,r=arguments.length>1?arguments[1]:void 0;return"function"==typeof e&&(r=e,e=null),o.create("uuapp.logging",(function(){
var t=o.get("uuapp.logging");return e&&e.forEach((function(e){return t.bindEmitter(e)})),r()}))}},{key:"set",value:function(e,r){}},{key:"get",value:function(e){}},{key:"clear",value:function(){
var e=o.get("uuapp.logging");e&&e.set("mdc",{})}},{key:"toJson",value:function(){var e=o.get("uuapp.logging");if(e){var r=e.get("mdc");if(r)return i.stringify(r)}return"{}"}}],
(t=null)&&a(r.prototype,t),n&&a(r,n),e}();l.set=c(o,"uuapp.logging","mdc"),l.get=u(o,"uuapp.logging","mdc"),e.exports=l},function(e,r,t){e.exports=t(6)},function(e,r,t){
...
;"/4.0.0/"===(o=o.split(/\//).slice(0,-1).join("/")+"/").substr(-"/4.0.0/".length)&&(o=o.substr(0,o.length-"/4.0.0/".length)+"/4.8.2/"),t.p=o,e.exports=t(8)},function(e,r){
