...
if (uri.substr(-floatingVersion.length) === floatingVersion) uri = uri.substr(0, uri.length - floatingVersion.length) + "/5.5.0/";
...
var PerflogHandler = __webpack_require__(142);

var RemoteErrorHandler = __webpack_require__(150);

var TransformParametersHandler = __webpack_require__(154);

var UriHandler = __webpack_require__(158);

var CsrfTokenHandler = __webpack_require__(159);

var RetryHandler = __webpack_require__(160);
...
var Client = /*#__PURE__*/function () {
  ...
  _createClass(Client, [{
    key: "get",
    value: function () {
      var _get = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(uri, dtoIn, options) {
    ...
    key: "post",
    value: function () {
      var _post = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(uri, dtoIn, options) {
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                return _context2.abrupt("return", this._invoke("post", uri, dtoIn, options));
    ...
    key: "_invoke",
    value: function () {
      var _invoke2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(method, uri, dtoIn, options) {
        var _this = this;
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt("return", invocationChain.invoke(request, options));
      ...
      function _invoke(_x7, _x8, _x9, _x10) {
     ...
     */
    function () {
      var _get2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(uri) {
        var dtoIn,
            options,
            _args4 = arguments;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                dtoIn = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : null;
                options = _args4.length > 2 && _args4[2] !== undefined ? _args4[2] : null;
                return _context4.abrupt("return", new Client().get(uri, dtoIn, options));
    ...
    key: "post",
    value: function () {
      var _post2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(uri) {
        var dtoIn,
            options,
            _args5 = arguments;
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                dtoIn = _args5.length > 1 && _args5[1] !== undefined ? _args5[1] : null;
                options = _args5.length > 2 && _args5[2] !== undefined ? _args5[2] : null;
                return _context5.abrupt("return", new Client().post(uri, dtoIn, options));
...
var ConfigChain = __webpack_require__(105);

var Json = __webpack_require__(103);

if (typeof window == "undefined") {
  var DupValidator = __webpack_require__(108);
  ...
  _createClass(Config, null, [{
    ...
    value: function activateProfiles() {
      ...
      if (typeof window == "undefined") {
        ...
        var cfgDir = Object({"NAME":"uu_appg01_core","VERSION":"5.5.0","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})["CONFIG_DIR"] || Config._getDefaultConfigDir();

        var sysCfgDir = Object({"NAME":"uu_appg01_core","VERSION":"5.5.0","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})["SYS_CONFIG_DIR"] || Config._getDefaultSysConfigDir();
    ...
    value: function _getChain() {
      ...
      if (!chain) {
        ...
        if (actProf.length === 0) {
          var envProfiles = Object({"NAME":"uu_appg01_core","VERSION":"5.5.0","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})["CONFIG_PROFILE"] || "development";
    ...
    value: function load() {
      ...
      try {
        if (this._fileSrc !== undefined && this._fileSrc) {
          ...
          var _data = Object({"NAME":"uu_appg01_core","VERSION":"5.5.0","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})[this._senvSrc] || "";

          this._data = this._parse(_data);
        } else if (this._menvSrc !== undefined && this._menvSrc) {
          loadedSrc = this._menvSrc;
          var regex = this._menvSrc;
          var envKeys = Object.keys(Object({"NAME":"uu_appg01_core","VERSION":"5.5.0","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""}));
          var result = {};
          envKeys.forEach(function (key) {
            if (regex.test(key)) {
              result[key.toLowerCase()] = Object({"NAME":"uu_appg01_core","VERSION":"5.5.0","NAMESPACE":"UuApp","OUTPUT_NAME":"uu_appg01_core","NODE_ENV":"development","TARGET_ENVIRONMENT":"browser","MOCK_DATA_BASE_URI":""})[key];
            }
          });
          this._data = result;
        }
...
var ValueConverter = __webpack_require__(106);
...
var Loader = __webpack_require__(107);
...
var CLS = __webpack_require__(114);
...
var _sha = __webpack_require__(121);
...
(function () {
  ...
  var AMD =  true && __webpack_require__(122);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(101), __webpack_require__(116), __webpack_require__(95)(module)))
...
var Digest = __webpack_require__(120);

var toPrunedJson = __webpack_require__(124);
/**
...
var Mutex = /*#__PURE__*/function () {
  ...
  _createClass(Mutex, [{
     ...
     */
    function () {
      var _sleep = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(ms) {
        var initiated;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
     ...
     */
    function () {
      var _yield2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
        ...
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                initiated = Date.now();
                interrupt = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
                  return regeneratorRuntime.wrap(function _callee3$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
...
var makeResponse = __webpack_require__(132);
...
var HttpClient = /*#__PURE__*/function () {
  ...
  _createClass(HttpClient, [{
    key: "invoke",
    value: function () {
      var _invoke = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(request) {
        var options,
            opts,
            canHaveBody,
            url,
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                timeout = opts.getNumber("requestTimeout", 300);

                if (this._logger.isDebugLoggable()) {
                  this._logger.debug("Invoking Ajax request: " + Json.stringify({
                ...
                usedHeaders = {};
                _context2.t0 = regeneratorRuntime.keys(headers);
    ...
    value: function _getResponseStream(response) {
        ...
        if (list) {
          ...
          listCopy.forEach(function (listenerFn) {
            try {
              ...
              _this._logger.error(e); // continue with next listener
      ...
      if (!stream[Symbol.asyncIterator]) {
        stream[Symbol.asyncIterator] = /*#__PURE__*/_wrapAsyncGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {
      ...
      var startConsumingStream = /*#__PURE__*/function () {
        var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5() {
          ...
          }, _callee5, null, [[3, 40], [6, 23, 27, 37], [28,, 32, 36]]);
        }));
...
var Logger = __webpack_require__(135);

var LoggerFactory = __webpack_require__(140);

var LogLevel = __webpack_require__(136);

var MessageFormatter = __webpack_require__(137);

var LoggerMDC = __webpack_require__(138);
...
var LoggerMDC = __webpack_require__(138); // Regexp to match formatting tags.
// @private
...
var _require = __webpack_require__(98),
    ...
    Json = _require.Json; // environment specific implementations
...
module.exports = {
  Perflog: __webpack_require__(144),
  Section: __webpack_require__(146),
  SectionId: __webpack_require__(149),
  Logger: __webpack_require__(147),
  MessageFormatter: __webpack_require__(148)
};
...
var Section = __webpack_require__(146);

var SectionId = __webpack_require__(149);

var Logger = __webpack_require__(147);
...
var Perflog = /*#__PURE__*/function () {
  ...
  _createClass(Perflog, null, [{
    key: "initialize",
    value: // In browser, section nesting is not supported
    function initialize() {
...
var LoggerFactory = __webpack_require__(134).LoggerFactory;

var BaseLogger = __webpack_require__(134).Logger;

var LogLevel = __webpack_require__(134).LogLevel;

var MessageFormatter = __webpack_require__(148);
    ...
    value: function _getLogger() {
      if (!this._logger) {
        ...
        if (!Config.get("".concat(LOGGER_NAME.toLowerCase(), ".log_level"), false)) {
          Config.set("".concat(LOGGER_NAME.toLowerCase(), ".log_level"), "OFF");
...
var BaseMessageFormatter = __webpack_require__(134).MessageFormatter;
...
var ApplicationError = __webpack_require__(151);

var SystemError = __webpack_require__(153);
/**
...
var RemoteError = __webpack_require__(152);
...
var ContentTransformers = __webpack_require__(155);
...
var MultiPart = __webpack_require__(156);

var dotNotate = __webpack_require__(157);
...
var RetryHandlerCore = __webpack_require__(161);
/**
...
var InvalidParameters = __webpack_require__(162);
...
var RetryHandlerCore = /*#__PURE__*/function () {
  ...
  _createClass(RetryHandlerCore, [{
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 8:
                ...
                this._logger.debug("Request failed and wont be repeated as it contains binary stream. requestId=".concat(this._originalRequestId));
    ...
    value: function () {
      var _processRetryPolicy2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(request, response, options) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 4:
                ...
                this._logger.debug("Request wont be repeated. Response retry-after header is after max time interval. requestId=".concat(this._originalRequestId, ", retryAfter=").concat(retryAfter, ", maxTimeInterval=").concat(this._options.maxTimeInterval));

                return _context2.abrupt("return", response);

              case 8:
                request.headers["x-request-id"] = "".concat(this._originalRequestId, "-").concat(this._attempt.toString().padStart(3, "0"));
                ...
                this._logger.error("Request failed. Retry conditions valid, retrying the request in ".concat(sleepTime, "ms. originalRequestId=").concat(this._originalRequestId, ", originalResponseStatus=").concat(response.status, ", originalResponseData=").concat(response.data, ", attempt=").concat(this._attempt, ", retryPolicy=").concat(Json.stringify(this._options)));
    ...
    key: "_timeout",
    value: function () {
      var _timeout2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(ms) {
        return regeneratorRuntime.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
    ...
    value: function _shouldRetry(request, response, options) {
      ...
      if (this._attempt > this._options.maxAttempts) {
        this._logger.debug("Request wont be repeated. Max attempts exceeded. requestId=".concat(this._originalRequestId, ", requestAttempt=").concat(this._attempt, ", maxAttempts=").concat(this._options.maxAttempts));
      ...
      if (!this._checkHttpMethod(this._options.retryCondition.httpMethods, request.method)) {
        this._logger.debug("Request wont be repeated. Http method condition invalid. requestId=".concat(this._originalRequestId, ", requestHttpMethod=").concat(request.method, ", retryHttpMethods=").concat(this._options.retryCondition.httpMethods));
      ...
      if (!this._options.retryCondition.httpStatusCodes || !this._checkStatusCode(this._options.retryCondition.httpStatusCodes, response.status.toString())) {
        this._logger.debug("Request wont be repeated. Http status condition invalid. requestId=".concat(this._originalRequestId, ", responseHttpStatus=").concat(response.status.toString(), ", retryHttpStatus=").concat(this._options.retryCondition.httpStatusCodes));
    ...
    */
    ...
    value: function _validateOptions(options) {
      ...
      if (_typeof(options.retryPolicy) !== "object") {
      ...
      if (_typeof(options.retryPolicy.retryCondition) !== "object") {
      ...
      options.retryPolicy.retryCondition.httpMethods.forEach(function (method) {
        ...
        if (!availableMethods.includes(method)) {
          throw new InvalidParameters("Incorect httpMethod - ".concat(method, " in retryCondition.httpMethods list. Should be one of ").concat(Json.stringify(availableMethods)));
        }
      });
      ...
      options.retryPolicy.retryCondition.httpStatusCodes.forEach(function (method) {
        ...
        if (!method.match(checkStatusRegex)) {
          throw new InvalidParameters("HttpStatusCode in retryCondition.httpStatusCodes must meet regex pattern ".concat(pattern));
        }
      });
      return true;
    }
...
var Uri = __webpack_require__(165);

var UriBuilder = __webpack_require__(166);

var InvalidUriPartError = __webpack_require__(168);
...
var UriParser = __webpack_require__(167);
/**
...
var AuthenticationService = /*#__PURE__*/function () {
  ...
  _createClass(AuthenticationService, null, [{
    ...
    value: function () {
      var _authenticateSystemIdentity = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
        var scope,
            realization,
            _args2 = arguments;
        return regeneratorRuntime.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return realization.authenticateSystemIdentity(scope);
              ...
              case 8:
                _context2.next = 10;
                return realization.authenticateSystemIdentity();
...
var UntrustedCredentials = __webpack_require__(172);
/**
...
var AuthenticationError = __webpack_require__(173);
/**
...
var Errors = __webpack_require__(178);
...
var APP = "(".concat(IDENTIFIER, "{1,32})");
var SUB_APP = "(".concat(IDENTIFIER, "{1,32})");
var ASID = "(".concat(IDENTIFIER, "{1,32})");
var AWID = "(".concat(IDENTIFIER, "{1,32})");
var APP_KEY_REGEXP = new RegExp("^(?:".concat(APP_KEY_URN_PREFIX, ")?").concat(VENDOR, "(?:\\-(?:").concat(APP, "(?:\\-(?:").concat(SUB_APP, "(?:\\/(?:").concat(ASID, "(?:\\-(?:").concat(AWID, ")?)?)?)?)?)?)?)?$"));
/**
...
var UuAppKey = /*#__PURE__*/function () {
  ...
  _createClass(UuAppKey, [{
    ...
    value: function toString() {
      ...
      parts = parts.concat(this._asid ? [["/", this._asid], ["-", this._awid]] : [["/", this._awid]]);
    ...
    value: function valueOf(vendor, app, supApp, asid, awid) {
      ...
      [[APP, app, "app"], [SUB_APP, supApp, "subApp"], [AWID, awid, "awid"], [ASID, asid, "asid"]].forEach(function (_ref) {
        ...
        if (!partValue) {
          ...
          if (!partValue.match("^".concat(regexp, "$"))) {
...
var InvalidAppKey = /*#__PURE__*/function (_BaseError) {
  ...
  function InvalidAppKey(invalidKey) {
    ...
    _this = _super.call(this, "The AppKey (".concat(invalidKey, ") is not valid."), null);
    _this.code = "".concat(ERROR_PREFIX, "invalidAppKey");
    return _this;
  }
...
var InconsistentAppKey = /*#__PURE__*/function (_BaseError2) {
  ...
  function InconsistentAppKey(partName, partValue) {
    ...
    _this2 = _super2.call(this, "The AppKey is not valid. The ".concat(partName, " part (").concat(partValue, ") is not valid. Null value was expected because some AppKey part before was null."), null);
    _this2.code = "".concat(ERROR_PREFIX, "inconsistentAppKey");
    return _this2;
  }

  return InconsistentAppKey;
}(BaseError);
...
var InvalidAppKeyPart = /*#__PURE__*/function (_BaseError3) {
  ...
  function InvalidAppKeyPart(partName, partValue) {
    ...
    _this3 = _super3.call(this, "The AppKey is not valid. The ".concat(partName, " part (").concat(partValue, ") is not valid."), null);
    _this3.code = "".concat(ERROR_PREFIX, "invalidAppKeyPart");
    return _this3;
  }

  return InvalidAppKeyPart;
}(BaseError);

module.exports = {
  InvalidAppKey: InvalidAppKey,
  InconsistentAppKey: InconsistentAppKey,
  InvalidAppKeyPart: InvalidAppKeyPart
};
