    ...
    return (
      ...
      >
        <Plus4U5.App.MenuTree
          ...
          items={[
            { id: "home", icon:"mdi-video" , href: "home", content: <UU5.Bricks.Lsi lsi={Lsi.left.home} /> },
            { id: "categories", icon: "mdi-tag-multiple", href: "categories", content: <UU5.Bricks.Lsi lsi={Lsi.left.category} /> },
          ]}
        />
      </Plus4U5.App.Left>
    );
